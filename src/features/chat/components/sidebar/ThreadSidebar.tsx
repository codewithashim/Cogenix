              ...
              >
                ...
                {hoveredThread === thread._id && (
                  <button
                    ...
                    className="flex-shrink-0 p-1 hover:bg-red-100 dark:hover:bg-red-900/20 rounded transition-colors cursor-pointer"
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 md:hidden p-2 rounded-lg bg-white dark:bg-[#2A2A2A] border border-gray-200 dark:border-gray-700 shadow-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors cursor-pointer"
      ...
      >
        ...
        <div className="p-3 border-b border-gray-200 dark:border-gray-800">
          <button
            ...
            className="w-full px-4 py-2.5 bg-white dark:bg-[#2A2A2A] hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-2 shadow-sm hover:shadow cursor-pointer"
          >
        ...
        <div className="p-3 border-t border-gray-200 dark:border-gray-800 space-y-2">
          ...
          {onOpenSettings && (
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-[#2A2A2A] transition-colors text-gray-700 dark:text-gray-300 cursor-pointer"
            >
